    ...
    <div className="w-80 bg-[#16161f] border border-white/10 rounded-xl shadow-2xl overflow-hidden">
      ...
      <div className="flex items-center justify-between px-4 py-3 border-b border-white/5 bg-white/[0.02]">
        <div className="flex items-center gap-2">
          ...
          <span className="text-sm font-medium text-white">Advanced Audio Settings</span>
        </div>
        {onClose && (
          <button
            onClick={onClose}
      ...
      <div className="p-4 space-y-5 max-h-[50vh] overflow-y-auto scrollbar-thin scrollbar-thumb-white/10 scrollbar-track-transparent">
        ...
        {track.audioSettings.inputMode === 'microphone' && (
          <>
            ...
            {/* Channel Selection */}
            <div className="space-y-2">
              <label className="text-xs font-medium text-zinc-400">Input Channels</label>
              <div className="grid grid-cols-2 gap-2">
                <button
        ...
        <div className="space-y-2">
          <div className="flex items-center justify-between">
            <label className="text-xs font-medium text-zinc-400">Input Gain</label>
        ...
        <div className="space-y-2">
          <div className="flex items-center justify-between">
            <label className="text-xs font-medium text-zinc-400">Direct Monitoring</label>
            <button
        ...
        {track.audioSettings.inputMode === 'microphone' && (
          <div className="space-y-2">
            ...
            <p className="text-[10px] text-zinc-600">Disable all for audio interfaces & instruments</p>
          </div>
        )}
