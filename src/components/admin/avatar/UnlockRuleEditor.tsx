        ...
        if (response.ok) {
          ...
          setRules(prev => prev.map(r =>
            r.id === editingRule.id ? {
              ...
              unlockType: formType,
              levelRequired: formType === 'level' && formConditionValue ? parseInt(formConditionValue) : undefined,
              achievementId: formType === 'achievement' ? formConditionKey || undefined : undefined,
              statisticKey: formType === 'statistic' ? formConditionKey || undefined : undefined,
              statisticValue: formType === 'statistic' && formConditionValue ? parseFloat(formConditionValue) : undefined,
              statisticOperator: formType === 'statistic' ? '>=' : undefined,
            } : r
          ));
